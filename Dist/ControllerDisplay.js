...
class ControllerDisplay {
    constructor() {
        ...
        if (navigator.bluetooth) {
            document.getElementById('deviceActions').addEventListener('change', this.onSelectDeviceAction);
            document.getElementById('deviceActionsButton').addEventListener('click', this.onClickDeviceActionButton);
        }
        else {
